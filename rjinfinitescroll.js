...
/**
 * @ngdoc directive
 * @name rjinfinitescroll
 * @description
 * # rjinfinitescroll
 */

var _r;
_r = angular.module('rjInfinitescroll', []);
_r.value('THROTTLE_MILLISECONDS', 1000)
    .directive('rjInfinitescroll', ['$rootScope', '$window', '$interval', 'THROTTLE_MILLISECONDS',
